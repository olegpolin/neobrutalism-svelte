...
<Dialog.Root bind:open>
  ...
  <Dialog.Content
    ...
    class="bg-clip-padding p-2 pb-11"
  >
    ...
    <div
      class="absolute inset-x-0 bottom-0 z-20 flex h-10 items-center gap-2 rounded-b-xl border-t px-4 text-xs font-medium text-muted-foreground"
    >
